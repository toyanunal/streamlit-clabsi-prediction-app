...
def main():
    st.set_page_config(
        page_title="KİKDE Gelişimi Tahminleme Modeli",
        page_icon="random",
        layout="centered",
        initial_sidebar_state="auto",
        )

    st.title("Kateter İlişkili Kan Dolaşımı Enfeksiyonu Gelişimi Tahminleme")
    st.write("[![Star](https://img.shields.io/github/stars/toyanunal/streamlit-clabsi-prediction-app.svg?logo=github&style=social)](https://gitHub.com/toyanunal/streamlit-clabsi-prediction-app)")
